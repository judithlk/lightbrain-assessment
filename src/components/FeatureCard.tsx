...
export default function FeatureCard({
  ...
  return (
    <div className="min-w-[300px] shadow-lg h-fit bg-white">
      <div>
        <Image
          src={image}
          alt={title}
